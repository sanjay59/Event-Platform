        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between pt-3">
              <div class="pb-2 pb-sm-3"><h4 class="page-title">Live Login Data</h4></div><div class="pb-3">
                 <a href="{{url('login-data')}}" class="btn btn-sm btn-outline-success waves-effect waves-light"><i class="mdi mdi-download font-15 mr-1"></i> Export CSV</a>
              </div></div></div>
