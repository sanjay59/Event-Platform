...
<script type="text/javascript">
 $(document).ready(function() {
   setInterval(function() {
     $('#registeruserref').load('changepg').fadeIn('fast');
   }, 10000)
 });
</script>
@endif
    ...
    <div class="modal-dialog modal-lg mt-2">
      <div class="modal-content border-0 rounded-0">
        ...
        <div class="modal-body">
          <iframe src="https://apc.vbooth.me/booth/pd383RLV" allow="accelerometer;camera;microphone; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" class="border-0 w-100"></iframe>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="photo-gallery-modal">
    <div class="modal-dialog modal-xl mt-2">
      <div class="modal-content border-0 rounded-0">
        ...
        <div class="modal-body">
          <iframe src="https://apc.vbooth.me/gallery/pd383RLV?fs=0" class="border-0 w-100"></iframe>
        </div>
      </div>
    </div>
  </div>
